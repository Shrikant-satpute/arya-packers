        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <span className="text-lg font-bold block">Arya Packers</span>
                <span className="text-[10px] tracking-wider uppercase text-[#f59e0b]">
                  & Movers
                </span>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Trusted and professional relocation service provider based in Kamothe, Navi Mumbai.
              Safe, fast, and affordable packing & moving services.
            </p>
